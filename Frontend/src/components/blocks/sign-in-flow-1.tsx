  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      <AuroraBackground className="absolute inset-0">
        ...
        >
          <div className="max-w-md w-full mx-auto rounded-2xl p-8 shadow-input bg-black/50 backdrop-blur-xl border border-white/10 z-10">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                className="bg-gradient-to-br relative group/btn from-black to-neutral-600 block w-full text-white rounded-md h-11 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                type="submit"
                disabled={loading}
              >
                {loading ? 'Signing in...' : 'Sign In →'}
              ...
              <div className="text-center text-neutral-300 text-sm mt-4">
                Don't have an account?{" "}
                <a
                  href="/signup"
  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full border-none bg-white/5 text-white shadow-input rounded-md px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-400 focus-visible:outline-none focus-visible:ring-[2px] focus-visible:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50 shadow-[0px_0px_1px_1px_var(--neutral-700)] group-hover/input:shadow-none transition duration-400",
          className
        )}
        ref={ref}
        {...props}
