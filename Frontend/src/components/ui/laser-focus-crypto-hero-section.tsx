                ...
                <div className="relative xl:max-w-7xl max-w-6xl mx-auto py-4 lg:px-0 px-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-2xl font-bold text-white">Arthos</span>
                        </div>
                        ...
                        <a href="/signup" className="bg-white text-black hover:bg-gray-100 px-6 py-2 rounded-full font-medium transition-colors duration-200 flex items-center gap-2">
                            Start Now
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center pt-20 pb-16">
                <div className="xl:max-w-7xl max-w-6xl  w-full mx-auto lg:px-0 px-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-16">
                        <a href="/signup" className="bg-white text-black hover:bg-gray-100 px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 flex items-center justify-center gap-2">
                            Start Now
                            <ArrowRight className="w-5 h-5" />
                        </a>

                        <button className="border border-gray-600 bg-transparent hover:bg-gray-900/50 text-white px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300">
                            Contact Us
                        </button>
                    </div>
                </div>
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-800/50">
                            <div className="flex items-center gap-8">
                                ...
                                <div className="flex items-center gap-6">
                                    <button className="text-white font-medium">Trade</button>
                                    <button className="text-gray-400 hover:text-white">Portfolio</button>
                                    <button className="text-gray-400 hover:text-white">Balance</button>
                                    <button className="text-gray-400 hover:text-white">Transaction History</button>
                                </div>
                            </div>
                            ...
                            <div className="lg:col-span-1">
                                <div className="bg-gray-900/50 rounded-lg p-4 h-80">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <div className="relative h-48 bg-black/50 rounded">
                                            ...
                                            <div className="absolute top-4 left-4 text-white text-lg font-bold">415000.00</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
