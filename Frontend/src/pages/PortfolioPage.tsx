  ...
  return (
    <div className="flex-1 p-6 bg-neutral-900 overflow-auto">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-6">Digital Assets / Portfolio</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-neutral-800 p-6 rounded-xl border border-neutral-700">
            <h3 className="text-lg font-semibold text-white mb-2">Stocks</h3>
            <p className="text-3xl font-bold text-white">12</p>
            <p className="text-sm text-neutral-400 mt-2">$8,234 value</p>
          </div>
        </div>
      </div>
    </div>
